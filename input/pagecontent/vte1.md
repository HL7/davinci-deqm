...
The example presented is based on the QDM version of [CMS108v13](https://ecqi.healthit.gov/ecqm/hosp-inpt/2025/cms0108v13), which has been represented using profiles derived from QI-Core. Measure specifications are available on the [ECQI Resource Center](https://ecqi.healthit.gov/). Additional information regarding the measure specification can be found in the [Quality Measure Implementation Guide].
...
{% include img.html img="DEQM Resource Diagram - VTE1.jpg" caption = "Figure 4.3-1 MeasureReport Using MedicationAdministration and Condition" %}
...
{% include img.html img="DEQM Resource Diagram - VTE2.jpg" caption = "Figure 4.3-2 MeasureReport Using DeviceUseStatement and Encounter" %}
...
{% include img.html img="DEQM Resource Diagram - VTE3.jpg" caption = "Figure 4.3-3 MeasureReport Using Observation" %}
...
{% include img.html img="DEQM Resource Diagram - VTE4.jpg" caption = "Figure 4.3-4 MeasureReport Using Encounter" %}
...
{% include img.html img="DEQM Resource Diagram - VTE5.jpg"  caption = "Figure 4.3-5 MeasureReport Using Encounter with Principal Diagnosis" %}
...
{% include img.html img="DEQM Resource Diagram - VTE6.jpg" caption = "Figure 4.3-6 MeasureReport Using Procedure/ServiceRequest and Encounter" %}
...
{% include img.html img="DEQM Resource Diagram - VTE7.jpg" caption = "Figure 4.3-7 MeasureReport Using MedicationRequest, DeviceRequest, MedicationStatement or DeviceUseStatement" %}
