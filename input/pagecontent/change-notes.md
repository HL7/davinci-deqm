...
1. Applied the following trackers:
   ...
   - Added Ad Hoc Operation Reporting input example and guidance ([FHIR-40722](https://jira.hl7.org/browse/FHIR-40722))([Applied here](Bundle-ad-hoc-operation-reporting-input.html)), ([here](all-examples.html#bundles)) and ([here](guidance.html#ad-hoc-organizations-for-deqm-operations))
