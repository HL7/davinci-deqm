...
1. Applied the following trackers:
   ...
   - rework the ad-hoc Organization for $care-gaps and $collect-data ([FHIR-50053](https://jira.hl7.org/browse/FHIR-50053)) Applied ([here](OperationDefinition-care-gaps.html)), ([here](OperationDefinition-care-gaps.html)), ([here](guidance.html)), and ([here](/Organization-ad-hoc-operation-input-example.html))
