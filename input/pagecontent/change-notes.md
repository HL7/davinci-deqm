...
1. Applied the following trackers:
   ...
   - Consider adding Annotation capability from Risk Adjustment to the Individual MeasureReport([FHIR-40675](https://jira.hl7.org/browse/FHIR-40675)) Applied ([here](StructureDefinition-deqm-careGapRemark.html)), ([here](CodeSystem-deqm-care-gap-remark.html)), ([here](ValueSet-care-gap-remark.html)), ([here](CodeSystem-remark-reason.html)), ([here](ValueSet-remark-reason.html)), ([here](gaps-in-care-reporting.html)), and ([here](StructureDefinition-deqm-individualmeasurereport.html))
   ...
   - Added Location Aware example bundle and verbiage to guidance page.  ([FHIR-40184](https://jira.hl7.org/browse/FHIR-40184)) Applied ([here](guidance.html#location-awareness-in-measure-reports)), ([here](all-examples.html#bundles)) and ([here](Bundle-Location-Aware-example.html))
