...
{% include img.html img="col-option1-using-observation.png" caption ="Figure 4.2-1 Measure Report Using Observation" %}
...
{% include img.html img="col-option2-using-diagnostic-report.png" caption ="Figure 4.2-2 Measure Report Using DiagnosticReport" %}
...
There are often times exclusions in a screening measure.  An exclusion is something that removes the requirement for a screening measure.  For example, a total colectomy removes the requirement for Colorectal Cancer Screening.  As with the other options, the measure defines the valueset/codes that constitute a qualifying procedure.  The following diagram shows how you would use a DEQM Data Exchange MeasureReport and its associated resources to report a procedure that represents an exclusion to the measure.
 ...
 {% include img.html img="col-option3-using-procedure.png" caption ="Figure 4.2-3 Measure Report Using Procedure"%}
...
{:.no_toc}
 ...
 {% include img.html img="col-option4-using-condition.png" caption ="Figure 4.2-4 Measure Report Using Condition"%}
...
{% include img-portrait.html img="COL Worklow Diagram - Data Exchange Indiv submit-data.jpg" caption = "Figure 4.2-5 Submit Data Technical Workflow" %}
