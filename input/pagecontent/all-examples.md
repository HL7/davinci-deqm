...
* [Example MeasureReport: Indv Patient-level linear](indv-measurereport-patient-level-linear.html)
* [Example MeasureReport: Indv Component-level weighted Composite](indv-measurereport-weighted-composite.html)
* [Example MeasureReport: Summ Patient-level linear](summary-measurereport-patient-level-linear.html)
* [Example MeasureReport: Summ Component-level weighted Composite](summary-measurereport-weighted-composite.html)
