...
**Scenario:**
The provider requested a Gaps in Care Report on 2020-06-30, which was for a group of patients (group id 123) for the gaps through period from 2020-01-01 to 2020-12-31. The provider received the report, which includes two patients: *gaps-patient01* and *gaps-patient02*. The report shows that *gaps-patient01* has an open gap, *gaps-patient02* has a closed gap, and *gaps-patient03* has a prospective gap for Colorectal Cancer Screening.

**Get Gaps in Care Report**
```
GET [base]/Measure/$care-gaps?measureurl=http://hl7.org/fhir/uv/deqm/Measure/measure-exm130-example|2.0.0&subject=Group/123&periodStart=2020-01-01&periodEnd=2020-12-31&status=open-gap&status=closed-gap&status=prospective-gap
```
        ...
        "entry": [
          ...
          },
          {
            ...
            "resource": {
              ...
              "period": {
                "start": "2020-03-07T07:00:00-00:00",
                "end": "2020-03-07T10:00:00-00:00"
              }
            }
          },
          {
        ...
        "entry": [
          ...
          },
          {
            ...
            "resource": {
              ...
              "performedPeriod": {
                "start": "2010-06-05T08:00:00-00:00",
                "end": "2010-06-05T09:00:00-00:00"
              }
            }
          },
          {
